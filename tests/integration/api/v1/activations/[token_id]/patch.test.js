...
describe("PATCH /api/v1/activations/[token_id]", () => {
  describe("Anonymous user", () => {
    test("With nonexistent activation token", async () => {
      const response = await fetch(
        "http://localhost:3000/api/v1/activations/50a9a66d-ed5b-4160-8aa8-d2d6bbf59059",
        {
          method: "PATCH",
        },
      );
    ...
    test("With valid activation token but already activated user", async () => {
      const createdUser = await orchestrator.createUser();
  ...
  describe("Default user", () => {
    test("With valid activation token but already logged in user", async () => {
